# ============================================================
# VGG16-BN FABRIC DEFECT CLASSIFICATION
# PART 1: SETUP, DATASET, MODEL, OPTIMIZER
# ============================================================
...
RESULT_DIR = ROOT_DIR / "results" / "vgg16_classification"
...
MODEL_SAVE_PATH = RESULT_DIR / "best_vgg16_bn.pt"
...
print("=" * 70)
print("VGG16-BN FABRIC DEFECT CLASSIFICATION")
print("=" * 70)
...
for class_index, class_name in enumerate(CLASSES):
    ...
    number_of_images = train_class_counts[class_index]

    print(

        f"{class_name:<15}: {number_of_images}"
...
print("Dataset, model, optimizer and scheduler are ready.")
# ============================================================
# VGG16-BN FABRIC DEFECT CLASSIFICATION
...
plt.title(
    "VGG16-BN Training and Validation Loss"
)
...
plt.title(
    "VGG16-BN Training and Validation Accuracy"
)
...
plt.title(
    "VGG16-BN Learning Rate Schedule"
)
...
print("\n")
print("=" * 70)
print("FINAL VGG16-BN TEST RESULTS")
print("=" * 70)
...
plt.title(
    "VGG16-BN Normalized Confusion Matrix"
)
