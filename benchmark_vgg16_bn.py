...
# This matches your original VGG16-BN training script.
MODEL_PATH = (
    ROOT_DIR
    / "results"
...
CSV_PATH = OUTPUT_DIR / "vgg16_benchmark.csv"
TXT_PATH = OUTPUT_DIR / "vgg16_benchmark.txt"
...
def load_trained_model():
    ...
    if not MODEL_PATH.exists():
        raise FileNotFoundError(
            "\nBest VGG16-BN checkpoint was not found at:\n"
            f"{MODEL_PATH}\n\n"
            "If best_vgg16_bn.pt is stored elsewhere, change MODEL_PATH "
    ...
    # Your VGG16-BN training code saved a checkpoint dictionary
...
def main():
    ...
    print(
        "Best trained VGG16-BN loaded successfully."
    )
    ...
    if tuple(output.shape) != (
        ...
        raise RuntimeError(
            "Unexpected VGG16-BN output shape."
        )
    ...
    print("\n")
    print("=" * 70)
    print("VGG16-BN BENCHMARK RESULTS")
    print("=" * 70)
