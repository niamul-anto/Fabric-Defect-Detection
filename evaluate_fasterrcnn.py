...
# আপনার best_model.pth এই folder-এ থাকলে এটি অপরিবর্তিত রাখুন
...
# Paper-এ এই threshold দুটি উল্লেখ করবেন
...
def evaluate_true_metrics(
    ...
    for images, targets in tqdm(
        ...
        for output, target in zip(outputs, targets):
            ...
            # Keep predictions above the selected confidence
            ...
            for class_id in range(1, NUM_CLASSES):
                ...
                for predicted_box in class_pred_boxes:
                    # A prediction exists but no GT of this class
                    ...
                    # A ground-truth box can be matched only once
...
def main():
    ...
    print("=" * 70)
    print("Faster R-CNN Corrected Test Evaluation")
    print("=" * 70)
    ...
    # True threshold-based Precision, Recall and F1
    ...
    print("\n" + "=" * 70)
    print("FINAL CORRECTED FASTER R-CNN TEST RESULTS")
    print("=" * 70)
    ...
    pd.DataFrame(
        ...
        OUTPUT_DIR / "fasterrcnn_true_test_results.csv",
        index=False,
    )
    ...
    pd.DataFrame(
        ...
        OUTPUT_DIR / "fasterrcnn_true_class_results.csv",
        index=False,
    )
